...
//						),
  ...
  public function format_analyze($filename) {
    $info = $this->analyze($filename);
    $formatted = array(
      'filesize' => isset($info['filesize']) ? $info['filesize'] : '',
      'filename' => isset($info['filename']) ? $info['filename'] : '',
      'filepath' => isset($info['filepath']) ? $info['filepath'] : '',
      'runtime' => isset($info['playtime_string']) ? $info['playtime_string'] : '',
      'audio_format' => isset($info['audio']['dataformat']) ? $info['audio']['dataformat'] : '',
      'audio_codec' => isset($info['audio']['codec']) ? $info['audio']['codec'] : '',
      'audio_channels' => isset($info['audio']['channels']) ? $info['audio']['channels'] : '',
      'audio_channelmode' => isset($info['audio']['channelmode']) ? $info['audio']['channelmode'] : '',
      'audio_sample_rate' => isset($info['audio']['sample_rate']) ? $info['audio']['sample_rate'] : '',
      'audio_bitrate' => isset($info['audio']['bitrate']) ? $info['audio']['bitrate'] : '',
      'video_format' => isset($info['video']['dataformat']) ? $info['video']['dataformat'] : '',
      'video_resolution_x' => isset($info['video']['resolution_x']) ? $info['video']['resolution_x'] : '',
      'video_resolution_y' => isset($info['video']['resolution_y']) ? $info['video']['resolution_y'] : '',
      'video_frame_rate' => isset($info['video']['frame_rate']) ? $info['video']['frame_rate'] : '',
      'video_codec' => isset($info['video']['codec']) ? $info['video']['codec'] : '',
      'video_bitrate' => isset($info['video']['bitrate']) ? $info['video']['bitrate'] : '',
    );
