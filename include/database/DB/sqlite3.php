...
function sqlite3_open($db) {
  return new SQLite3($db);
}

function sqlite3_query($connection, $query) {
  return $connection->query($query);
}

function sqlite3_exec($connection, $query) {
...
function sqlite3_query_close($result) {
}

function sqlite3_error($connection) {
  return $connection->lastErrorMsg();
}

function sqlite3_last_insert_rowid($connection) {
